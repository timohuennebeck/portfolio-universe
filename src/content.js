...
export const PROJECTS = [
  ...
  { id: 'unload', meta: ['Independent project', '2023 — 2024', 'Founder', 'Team of 1', '20 months'], github: 'https://github.com/timohuennebeck/unload-mobile-app', kind: 'Independent · 01', title: 'Unload', tint: '#ff5f6d', blackhole: true, tagline: 'An app for 14-to-20-year-olds breaking a compulsive habit, built on groups instead of streaks — 12,000 sign-ups, a viral launch, and a clear-eyed decision to shut it down.',
    sections: [
      { text: true, body: 'The insight behind it: the moment someone is about to relapse is not a moment for a lecture or a chart — [[it\'s a moment they need another person]]. So instead of a solo streak counter, Unload put people into small accountability groups. With nobody else on it, that meant the marketing and the support as much as the code.' },
      { numbers: true, body: 'Over twenty months, [[12,000+]] people signed up, [[about 800]] opened the app every month, and they rated it [[4.6 stars]] across more than 50 ratings. Subscriptions brought in up to [[€280]] a month at their peak.' },
