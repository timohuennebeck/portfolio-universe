...
export const PROJECTS = [
  { id: 'phase6', meta: ['Client work · Horizon Alpha', '2025', 'Frontend Developer', 'Team of 3', '5 weeks'], kind: 'Client work · 01', title: 'Phase6', tint: '#ffb066', tagline: 'Building the analytics Phase6 didn\'t have, finding the one screen where teachers gave up, and shipping the fix that took sign-ins from 10% to 26%.',
    sections: [
      ...
      { funnel: true, title: 'Test creation: before and after', note: 'The share of anonymous users still in the flow at each step. The step that mattered — signing in to keep the test you just built — went from one in ten to more than one in four.', tabs: [
        { label: 'Before the redesign', steps: [
          { label: 'Test creation started', pct: 100 },
          { label: 'Save prompt shown', pct: 47.66 },
          { label: 'Signed in to save', pct: 10.29 },
        ] },
        { label: 'After the redesign', steps: [
          { label: 'Test creation started', pct: 100 },
          { label: 'Save prompt shown', pct: 47.66 },
          { label: 'Signed in to save', pct: 26 },
        ] },
      ] },
